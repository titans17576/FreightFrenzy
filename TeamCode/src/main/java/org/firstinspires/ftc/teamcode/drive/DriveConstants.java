...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(0, 0, 0,
            17.773095287958114/*getMotorVelocityF(MAX_RPM / 60 * TICKS_PER_REV)*/);
     ...
     * empirically tuned.
     */
    public static double kV = 0.01712;
    public static double kA = 0.0015;
    public static double kStatic = 0.06923;
     ...
     * inches.
     */
    public static double MAX_VEL = 50; //65;
    public static double MAX_ACCEL = 55; //65;
