...
class Path_StartWarehouse_Vision_Park(is_red: Boolean, factory: TrajectoryBuilderFactory)
    ...
    init {
        trajectories.add(
            new_movement()
                .splineTo(Vector2d(7.0, -50 * side), 90.0.toRadians * side)
                .lineTo(Vector2d(7.0, -50.5 * side))
                .lineTo(Vector2d(7.0, -50 * side))
                .turn(-90.0.toRadians * side)
                .setReversed(true)
                .splineTo(Vector2d(-12.0, -43.0 * side), 90.0.toRadians * side)
                .waitSeconds(1.5)
                .lineTo(Vector2d(-12.0, -43.5 * side))
                .lineTo(Vector2d(-12.0, -43.0 * side))
                //.turn(-90.0.toRadians * side)
        ...
        trajectories.add(
            new_movement()
                .lineTo(Vector2d(-12.0, -57.5 * side))
                .turn(90.0.toRadians * side)
                .splineTo(Vector2d(8.5, -40.0 * side), 0.0.toRadians * side)
                .lineTo(Vector2d(8.25, -40.0 * side))
                //.turn(-90.0.toRadians * side)
                .lineTo(Vector2d(60.5, -40.0 * side))
                .build()
        )
    }
}